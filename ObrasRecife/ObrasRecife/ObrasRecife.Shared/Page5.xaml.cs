...
namespace ObrasRecife
{
    ...
    public sealed partial class Page5 : Page
    {
        public Page5()
        {
            ...
            MyMap.SetView(new BasicGeoposition() { Latitude = -8.0464493, Longitude = -34.9324882 }, 11);
        ...
        private void GoToRecifeBtn_Clicked(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            MyMap.SetView(new BasicGeoposition() { Latitude = -8.0464493, Longitude = -34.9324882 }, 11);
        }
